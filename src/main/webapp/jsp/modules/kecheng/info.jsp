            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">课程表登记</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="attendTime" name="attendTime" class="form-control"
                                               v-model="ruleForm.attendTime" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>下课时间</label>
                                ...
                                <div class="form-group col-md-6">
                                    <label>
                                        负责老师
                                        <input id="lsTypesSelect" name="lsTypesSelect" class="form-control"
                                        // v-model="ruleForm.lsTypes" readonly
                                        >
                                    </label>
                                </div>
                                <div class="form-group col-md-6">
...
<script>
    ...
    //查询当前页面下所有列表
        function lsTypesSelect() {
            //填充下拉框选项
            http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=ls_types", "GET", {}, (res) => {
                if(res.code == 0){
    ...
    function setSelectOption() {
        for (var i = 0; i < lsTypesOptions.length; i++) {
            if(lsTypesOptions[i].codeIndex == ruleForm.lsTypes){//下拉框value对比,如果一致就赋值汉字
                var lsTypesSelect = document.getElementById("lsTypesSelect");
                    lsTypesSelect.value = lsTypesOptions[i].indexName;
            }
        }
