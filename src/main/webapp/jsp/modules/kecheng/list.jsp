                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                        ...
                                        <label>
                                            ...
                                            <label>
                                                负责老师
                                                <select name="lsTypesSelectSearch" id="lsTypesSelectSearch" class="form-control form-control-sm"
...
<script>
    ...
    function search() {
        ...
        var lsTypesIndex = document.getElementById("lsTypesSelectSearch").selectedIndex;
        var lsTypesValue;
        if( lsTypesIndex  == 0){
                lsTypesValue='';
        }else{
                lsTypesValue= document.getElementById("lsTypesSelectSearch").options[lsTypesIndex].value;
        }

        searchForm.lsTypes = lsTypesValue;
    ...
    function setDataRow(item, number) {
        ...
        var attendTimeCell = document.createElement('td');
        attendTimeCell.innerHTML = item.attendTime;
        row.appendChild(attendTimeCell);
        ...
        courseCell.innerHTML = item.course;
        row.appendChild(courseCell);

        var lsTypesCell = document.createElement('td');
        for (var i = 0; i < lsTypesOptions.length; i++) {
            if(lsTypesOptions[i].id == item.lsTypes){//下拉框value对比,如果一致就赋值汉字
                    lsTypesCell.innerHTML = lsTypesOptions[i].name;
            }
        }
        row.appendChild(lsTypesCell);
    ...
    //填充搜索下拉框
            ...
            function lsTypesSelectSearch() {
                var lsTypesSelectSearch = document.getElementById('lsTypesSelectSearch');
                    lsTypesSelectSearch.add(new Option('请选择',''));
                for (var i = 0; i < lsTypesOptions.length; i++) {
                        lsTypesSelectSearch.add(new Option(lsTypesOptions[i].name,lsTypesOptions[i].id));
                }
            }
